...
async function sendOcean(pharse) {
    ...
    let oceansBalance = parseFloat(oceans.totalBalance) / 1e9;
...
// sendOcean('average section bachelor input swing brother surge swim sauce arrow hospital media')
